...
export const CategorieCard = ({ categorie , setCategorie}) => {
  return (
    <Link to={`categorias/${categorie.categoriaId}`} onClick={ ( ) => setCategorie(categorie.categoriaId)} >
       <div  className="flex flex-col gap-4 py-4 shadow-2xl p-2 rounded-2xl items-center justify-center hover:scale-105 hover:cursor-pointer border-2 border-transparent hover:border-Primary-400 transition-all mt-8 ">
