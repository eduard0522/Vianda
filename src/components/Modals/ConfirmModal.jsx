...
export const ConfirmModal = ({text,modal,setModal,link, textButton}) => {
  ...
  return(
    <dialog className=" z-30 w-full h-full absolute top-0 bottom-0 right-0 bg-re left-0 flex  items-center justify-center rounded-md bg-[#0e0e0e3c] backdrop-blur-sm shadow-2xl">
